...
greater_then_9_numbers = [number for number in numbers if number > 9]
print(greater_then_9_numbers)
...
longer_then_11 = [name.split()[1] for name in full_names if len(name) > 11]
print(", ".join(longer_then_11))
